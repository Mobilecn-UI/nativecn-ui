...
1. Ensure you have both the [Toast](https://github.com/Mobilecn-UI/nativecn-ui/blob/main/components/Avatar.tsx) and [ToastContext](https://github.com/Mobilecn-UI/nativecn-ui/blob/main/components/Avatar.tsx) in your `Components` folder.
